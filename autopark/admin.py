...
from autopark.models import Vehicle, Brand, Enterprise, Driver, Manager, Routes
...
class VehicleAdmin(admin.ModelAdmin):
    list_display = ('brand','owner','year_manufacture','mileage_value','condition','price_currency','date')
    list_per_page = 50
...
class BrandAdmin(admin.ModelAdmin):
    list_display = ('brand_name','type','tank_volume','seats_number','load_capacity')
    list_per_page = 10
...
class DriverAdmin(admin.ModelAdmin):
    list_display = ('id','name','residential_address','phone','job','car','status')
